...
if (!isset($_GET["success"]) && !empty($_POST)) {
	...
	if (!(recaptcha_check_answer ("6Lf1YdISAAAAAO6KeHBTb-6nlDNXMDxNz1lN_69O", $_SERVER["REMOTE_ADDR"], $_POST["recaptcha_challenge_field"], $_POST["recaptcha_response_field"])->is_valid)) {
...
if (isset($_GET["success"])) {
	...
	<form action="" method="POST">
		...
		<?php
		require_once($root."/lib/recaptchalib.php");
		print recaptcha_get_html("6Lf1YdISAAAAAEahyK08ueitqSRvI759xwSgCfqP");
		?>
